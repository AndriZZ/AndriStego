package com.example.andri.andristego.activities.encrypt;
...
import com.example.andri.andristego.R;
import com.example.andri.andristego.activities.stego.StegoActivity;
import com.example.andri.andristego.utils.Constants;
import com.example.andri.andristego.utils.StandardMethods;
...
public class EncryptActivity extends AppCompatActivity implements EncryptView {
  ...
  public void openCamera() {
    ...
    Uri imageUri = FileProvider.getUriForFile(this, "andri", file);
